  ...
  if(isset($_POST['add_veh']))
    {
            ...
            move_uploaded_file($_FILES["v_pic"]["tmp_name"],"../vendor/img/".$_FILES["v_pic"]["name"]);
            $v_status=$_POST['v_status'];
            $query="insert into tb_vehicle (v_reg,v_type,v_model,v_colour,v_price, v_pic,v_status ) values(?,?,?,?,?,?,?)";
            $stmt = $con->prepare($query);
            $rc=$stmt->bind_param('sssssss',$v_reg, $v_type,$v_model,$v_colour,$v_price, $v_pic, $v_status);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Vehicle Added";
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            <div class="form-group">
                ...
                <input type="text" required class="form-control" id="exampleInputEmail1" name="v_model">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Vehicle Registration Number</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_reg">
            </div>
...
<div class="form-group" id="otherCategoryContainer" style="display: none;">
    ...
    <input type="text" class="form-control" id="otherCategoryInput" name="otherCategoryInput">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_colour">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Vehicle Price</label>
                <input type="Number" class="form-control" id="exampleInputEmail1" name="v_price">
            </div>
